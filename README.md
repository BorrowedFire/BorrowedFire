...
- [Takeoff](skills/takeoff/SKILL.md): one-command closeout for committing, pushing, merging, deploying, and verifying.
- [Autoland](skills/autoland/SKILL.md): drive one PR through adversarial + Codex review, auto-fix, live proof, and merge-when-clean — surfacing only decision-ready asks.
